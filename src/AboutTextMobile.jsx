...
export default function AboutTextMobile() {
    ...
    return (
      ...
      <Float rotationIntensity={0.2} floatIntensity={0.5}>
        <Text color="white" anchorX="center" anchorY="middle" fontSize={.2} position={[0,6.3,1]} maxWidth={4} >
        <meshBasicMaterial          
          color={"#FFF"}
          fog={false}
        />
      ...
      <Float rotationIntensity={0.2} floatIntensity={0.5}>
        <Text color="white" anchorX="center" anchorY="middle" fontSize={.2} position={[0,5,1]} maxWidth={4} fog={false} >
        <meshBasicMaterial          
          color={"#FFF"}
          fog={false}
        />
      ...
      <Float rotationIntensity={0.3} floatIntensity={0.5}>
        <Text color="white" anchorX="center" anchorY="middle" fontSize={.2} position={[0,3.4,1]} maxWidth={4} >
        <meshBasicMaterial          
          color={"#FFF"}
          fog={false}
        />
      ...
      <Float rotationIntensity={0.3} floatIntensity={0.5}>
        <Text color="white" anchorX="center" anchorY="middle" fontSize={.2} position={[0,2.2,1]} maxWidth={4}>
        <meshBasicMaterial          
          color={"#FFF"}
          fog={false}
        />
